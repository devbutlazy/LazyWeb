!function (t, e) {
    ...
    function i(i, s, a) {
        ...
        a = a || e || t.jQuery, a && (s.prototype.option || (s.prototype.option = function (t) {
            a.isPlainObject(t) && (this.options = a.extend(true, this.options, t));
        }), a.fn[i] = function (t) {
            if ("string" == typeof t) {
    ...
    d.constructor = n, d._create = function () {
        ...
        var a = t - i, u = e - n, h = {};
        h.transform = this.getTranslate(a, u), this.transition({ to: h, onTransitionEnd: { transform: this.layoutPosition }, isCleaning: true });
        ...
        for (i in t.to) e.ingProperties[i] = true, t.isCleaning && (e.clean[i] = true);
        if (t.from) {
            this.css(t.from);
            var n = this.element.offsetHeight;
            n = null;
        }
        this.enableTransition(t.to), this.css(t.to), this.isTransitioning = true;
    };
    var l = "opacity," + o(a);
    d.enableTransition = function () {
        if (!this.isTransitioning) {
            var t = this.layout.options.transitionDuration;
            t = "number" == typeof t ? t + "ms" : t, this.css({ transitionProperty: l, transitionDuration: t, transitionDelay: this.staggerDelay || 0 }), this.element.addEventListener(u, this, false);
        }
    ...
    return d.removeTransitionStyles = function () {
        ...
        e[i] = this.onRevealTransitionEnd, this.transition({ from: t.hiddenStyle, to: t.visibleStyle, isCleaning: true, onTransitionEnd: e });
        ...
        e[i] = this.onHideTransitionEnd, this.transition({ from: t.visibleStyle, to: t.hiddenStyle, isCleaning: true, onTransitionEnd: e });
    ...
    s.namespace = "outlayer", s.Item = o, s.defaults = { containerStyle: { position: "relative" }, initLayout: true, originLeft: true, originTop: true, resize: true, resizeContainer: true, transitionDuration: "0.4s", hiddenStyle: { opacity: 0, transform: "scale(0.001)" }, visibleStyle: { opacity: 1, transform: "scale(1)" } };
    var c = s.prototype;
    n.extend(c, e.prototype), c.option = function (t) {
        n.extend(this.options, t);
    }, c._getOption = function (t) {
        var e = this.constructor.compatOptions[t];
        return e && undefined !== this.options[e] ? this.options[e] : this.options[t];
        ...
        var t = this._getOption("layoutInstant"), e = undefined !== t ? t : !this._isLayoutInited;
        this.layoutItems(this.items, e), this._isLayoutInited = true;
        ...
        return null === t || undefined === t ? void (this.stagger = 0) : (this.stagger = a(t), this.stagger);
        ...
        if (t) {
            ...
            e && (this._setContainerMeasure(e.width, true), this._setContainerMeasure(e.height, false));
        }
        ...
        return t ? ("string" == typeof t && (t = this.element.querySelectorAll(t)), t = n.makeArray(t)) : undefined;
        ...
        e.length && (this.layoutItems(e, true), this.reveal(e));
    }, c.prepended = function (t) {
        var e = this._itemize(t);
        if (e.length) {
            var i = this.items.slice(0);
            this.items = e.concat(i), this._resetLayout(), this._manageStamps(), this.layoutItems(e, true), this.reveal(e), this.layoutItems(i);
        }
    }, c.reveal = function (t) {
    ...
    "use strict";
    var i = t.create("masonry"), n = i.prototype, o = { _getElementOffset: true, layout: true, _getMeasurement: true };
    ...
    return n._getOption = function (t) {
        return "fitWidth" == t ? undefined !== this.options.isFitWidth ? this.options.isFitWidth : this.options.fitWidth : a.apply(this.isotope, arguments);
    }, i;
}), function (t, e) {
    ...
    function a(t, e) {
        return function (i, n) {
            for (var o = 0; o < t.length; o++) {
                ...
                if (r > a || a > r) {
                    var u = undefined !== e[s] ? e[s] : e, h = u ? 1 : -1;
                    return (r > a ? 1 : -1) * h;
                }
            }
            return 0;
    ...
    l._create = function () {
        ...
        this._resetLayout(), this._manageStamps(), this.layoutItems(this.filteredItems, t), this._isLayoutInited = true;
    ...
    d.sortDataParsers = {
        ...
        if (e.length) {
            ...
            for (i = 0; o > i; i++) e[i].isLayoutInstant = true;
